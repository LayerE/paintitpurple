        ...
        <div>
          ...
          <div className="grid items-start gap-12 sm:grid-cols-1 md:grid-cols-4 md:gap-16 sm:divide-y sm:divide-gray-200">
              ...
              <tfoot>
                {((discountValue && discountValue.amount) ||
                  ...
                  <tr>
                    ...
                    <td className="pt-6 pl-3 pr-4 font-semibold text-right text-green-700 md:pr-3">
                      {discountPercentage ? (
            ...
            <div className="sticky border-none top-nav md:my-8">
              ...
              <div
                className={`mt-3 px-3 py-1 text-xs font-semibold rounded-full inline-block w-auto ${
